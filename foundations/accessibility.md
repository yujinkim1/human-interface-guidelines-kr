...
**색상만을 사용하여 객체를 구별하거나 중요한 정보를 전달하지 마세요.**

정보 전달에 색상을 사용하는 경우 모든 사용자가 인식할 수 있도록 텍스트 레이블이나 글리프 모양을 제공해야 합니다.

<br />

**텍스트에는 시스템 색상을 사용하는 것이 좋습니다.**

텍스트에 시스템 색상을 사용하면 색상 반전 및 대비 증가와 같은 접근성 설정에 올바르게 응답합니다.

<br />

**두 상태나 값 사이를 구별하는 유일한 방법으로 색상 조합을 사용하지 않도록 합니다.** 
